...
from networks.Resnet_b import Resnet_b as Resnet_b
...
def main():
	...
	# Load Resnet_b network.
	print '====> Loading the network...'
	model = Resnet_b(num_class=args.num_class, num_frame=args.num_frame, pretrained=True)
