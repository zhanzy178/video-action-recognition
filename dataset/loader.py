...
def get_test_loader(args):
	...
	test_set = HMDB51Dataset(video_dir, frame_dir, meta_path, list_path, input_transform = test_data_transform, num_frame, refresh)
...
def get_train_loader(args):
	...
	train_set = HMDB51Dataset(video_dir, frame_dir, meta_path, list_path, input_transform = test_data_transform, num_frame, refresh)
